...
func TestSyncResolver_Process(t *testing.T) {
	resolver := resolvers.SyncResolver[string]{}
	elements := arraylist.List[string]{}
	elements.Add("1")
	elements.Add("2")
	elements.Add("3")
	...
	assert.LessOrEqual(t, elapsedTime, time.Duration(350)*time.Millisecond)
}
